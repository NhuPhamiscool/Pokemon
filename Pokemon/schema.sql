...
INSERT INTO Pokemon (ID, Name, Species, Average_Height, Average_Weight, Catch_Rate, Growth_Rate, Experience_Yield, Gender_Ratio)
VALUES (1, 'Bulbasaur', 'Seed Pokémon', 0.7, 6.9, 45, 'Medium Slow', 64, 87);

INSERT INTO Pokemon (ID, Name, Species, Average_Height, Average_Weight, Catch_Rate, Growth_Rate, Experience_Yield, Gender_Ratio)
VALUES (2, 'Ivysaur', 'Seed Pokémon', 1.0, 13.0, 45, 'Medium Slow', 142, 87);

INSERT INTO Pokemon (ID, Name, Species, Average_Height, Average_Weight, Catch_Rate, Growth_Rate, Experience_Yield, Gender_Ratio)
VALUES (3, 'Venusaur', 'Seed Pokémon', 2.0, 100.0, 45, 'Medium Slow', 236, 87);

INSERT INTO Pokemon (ID, Name, Species, Average_Height, Average_Weight, Catch_Rate, Growth_Rate, Experience_Yield, Gender_Ratio)
VALUES (4, 'Charmander', 'Lizard Pokémon', 0.6, 8.5, 45, 'Medium Slow', 62, 87);

INSERT INTO Pokemon (ID, Name, Species, Average_Height, Average_Weight, Catch_Rate, Growth_Rate, Experience_Yield, Gender_Ratio)
VALUES (5, 'Charmeleon', 'Flame Pokémon', 1.1, 19.0, 45, 'Medium Slow', 142, 87);

INSERT INTO Pokemon (ID, Name, Species, Average_Height, Average_Weight, Catch_Rate, Growth_Rate, Experience_Yield, Gender_Ratio)
VALUES (6, 'Charizard', 'Flame Pokémon', 1.7, 90.5, 45, 'Medium Slow', 240, 87);

INSERT INTO Pokemon (ID, Name, Species, Average_Height, Average_Weight, Catch_Rate, Growth_Rate, Experience_Yield, Gender_Ratio)
VALUES (7, 'Squirtle', 'Turtle Pokémon', 0.5, 9.0, 45, 'Medium Slow', 63, 87);

INSERT INTO Pokemon (ID, Name, Species, Average_Height, Average_Weight, Catch_Rate, Growth_Rate, Experience_Yield, Gender_Ratio)
VALUES (8, 'Wartortle', 'Turtle Pokémon', 1.0, 22.5, 45, 'Medium Slow', 142, 87);

INSERT INTO Pokemon (ID, Name, Species, Average_Height, Average_Weight, Catch_Rate, Growth_Rate, Experience_Yield, Gender_Ratio)
VALUES (9, 'Blastoise', 'Shellfish Pokémon', 1.6, 85.5, 45, 'Medium Slow', 239, 87);

-- Add more INSERT statements up to 100 as needed
